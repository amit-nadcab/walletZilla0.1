                ...
                <div className='row d-flex justify-content-center '>
                    <div className='col-sm-12 col-md-4'>
                        <div className='airdrop-rule-card m-1 d-flex align-items-center'>
                            ...
                            <div className='ms-3 text-white fw-bold  fs-4'>10 % of total Supply is allocated for airdrop</div>
                    ...
                    <div className='col-sm-12 col-md-4'>
                        <div className='airdrop-rule-card m-1 d-flex align-items-center'>
                            ...
                            <div className='ms-3 text-white fw-bold fs-4'>Earn 3/1 of your investment as Airdrop</div>
                        </div>
                    </div>
                </div>
