...
export const TokenDistibution = () => {
    return (
        <>
            <div class="about-area pt-100 pb-100" id="about">
                <div class="container">
                    <div className='row'>
                        <div className='col-12'>
                            
                            <h1 className='text-center mb-5 banner-gradiant'>Token Distribution</h1>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            ...
                            <div className="dreamit-about-thumb  me-5" data-wow-delay=".4s">
                                ...
                                <img className='img-fluid' src="assets/images/myImage/allocation .png" alt="" />
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12" style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                            <div class="dreamit-section-title pb-5" data-wow-delay=".5s">
                                ...
                                <p class="section-text">
                                    We are mined 5 Million WZT Token and it will be distributed in WZT Token holder during various systems.
                                </p>
                                {/* <p class="section-text">
